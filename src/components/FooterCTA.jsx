    ...
    <div className="bg-gray-900">
      <div className="mx-auto max-w-7xl px-6 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="mx-auto max-w-2xl text-center">
          <hgroup>
            <h2 className="text-base/6 font-semibold font-sans text-indigo-400">
              Out-of-home, without the overwhelm
            </h2>
          ...
          <p className="mx-auto mt-6 max-w-xl text-lg text-gray-400">
            We plan and manage your billboard campaigns end-to-end from strategy to booking,
      ...
      {/* Add padding *after* section so background extends */}
