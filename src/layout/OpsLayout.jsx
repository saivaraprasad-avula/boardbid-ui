...
export default function OpsLayout({ children, title }) {
  ...
  const current = navigation.find((n) => location.pathname === n.href);
  const computedTitle = title ?? current?.name ?? 'Ops';
      ...
      <div className="bg-black pb-4">
        ...
        <header className="py-10">
          <div className="px-4 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-bold tracking-tight text-white">{computedTitle}</h1>
          </div>
        </header>
      </div>
