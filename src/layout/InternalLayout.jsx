...
export default function InternalLayout({ children }) {
  ...
  const navigation = [
    ...
    { name: 'Upload Creative', to: '/upload-creative', icon: DocumentDuplicateIcon },
    { name: 'New Campaign', to: '/campaign/new', icon: FolderIcon },
    { name: 'Reports', to: '/reports', icon: ChartPieIcon },
    { name: 'Admin', to: '/admin', icon: UsersIcon },
  ];

  const currentPage = navigation.find((item) => item.to === pathname)?.name || 'Dashboard';
